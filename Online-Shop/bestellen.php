...
<html>
    ...
    <body>
        ...
        <form method="post" action="bestellt.php">
            ...
            <input name="email" placeholder="Email-Adresse" pattern=".+@(michelbartels|web|t-online|yahoo|gmail|outlook|hotmail|mail|email|gmx)\.(com|de|us|co|uk|co.uk)" required>
