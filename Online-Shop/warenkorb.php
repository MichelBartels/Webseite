                ...
                <tr>
                    <?php
                        ...
                        foreach ($_SESSION["Warenkorb"] as $id => $anzahl) {
                            ...
                            echo '<td class="name">' . $ergebnis["Name"] . '</td><td class="anzahl">' . $anzahl . '</td><td class="preis">' . number_format($ergebnis["Preis"], 2, ",", " ") . ' €</td><td class="loeschen"><a href="warenkorb_leeren.php?url=index.php&id=' . $id . '">X</a></td>';
                        }
                    ?>
                </tr>
            </tbody>
